...
from chargepal_pybullet.rl_gym.envs.config import ENVIRONMENT_PTP_3DOF_CARTESIAN_POSITION_CONTROL
# components
...
from chargepal_pybullet.rl_gym.controllers.controller_pos_3dof_cartesian import Position3dofCartesianController
