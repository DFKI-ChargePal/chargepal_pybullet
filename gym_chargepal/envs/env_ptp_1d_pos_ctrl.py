...
from chargepal_pybullet.gym_chargepal.envs.config import ENVIRONMENT_PTP_1DOF_CARTESIAN_POSITION_CONTROL
# components
...
from chargepal_pybullet.gym_chargepal.controllers.controller_pos_1dof_cartesian import Position1dofCartesianController
