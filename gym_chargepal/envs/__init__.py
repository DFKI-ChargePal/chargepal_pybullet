...
environment_register = {
    ...
    'ChargePal-Testbed-GuidedSearcher-6D-MotionControl-v0': config.testbed_guided_searcher_6dof_motion_ctrl_v0,
    'ChargePal-Testbed-GuidedSearcher-6D-ComplianceControl-v0': config.testbed_guided_searcher_6dof_compliance_ctrl_v0,
    'ChargePal-Testbed-GuidedSearcher-6D-ComplianceControl-v1': config.testbed_guided_searcher_6dof_compliance_ctrl_v1,
}
