...
@dataclass
class EnvironmentPluggerComplianceCtrlCfg(EnvironmentCfg[ObsType, ActType]):
    hw_interface: str = 'joint_velocity'


class EnvironmentPluggerComplianceCtrl(Environment[ObsType, ActType]):
    ...
    def __init__(self, **kwargs: dict[str, Any]):
        ...
        self.low_level_control = TCPComplianceController(
