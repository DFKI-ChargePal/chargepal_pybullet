...
from gym_chargepal.controllers.config import VELOCITY_6DOF_CARTESIAN_CONTROLLER
...
class Velocity6dofCartesianControllerC(Controller):
    ...
    def __init__(self, hyperparams: Dict[str, Any], jacobian: Jacobian, control_interface: JointVelocityMotorControl, plug_sensor: PlugSensor, joint_sensor: JointSensor):
